...
def plot_dataset(handRightPoints):
    
    ret_frame = []
    POSE_PAIRS = [ [0,1],[1,2],[2,3],[3,4],[0,5],[5,6],[6,7],[7,8],[0,9],[9,10],[10,11],[11,12],[0,13],[13,14],[14,15],[15,16],[0,17],[17,18],[18,19],[19,20] ]
    background = 'black_background.jpg'
    ...
    for pair in POSE_PAIRS:
        ...
        if handRightPoints[partA] and handRightPoints[partB]:
            cv2.line(frame, handRightPoints[partA], handRightPoints[partB], (0, 255, 255), 10)
            cv2.circle(frame, handRightPoints[partA], 5, (0, 0, 255), thickness=12, lineType=cv2.FILLED)
            cv2.circle(frame, handRightPoints[partB], 5, (255, 255, 255), thickness=17, lineType=cv2.FILLED)
